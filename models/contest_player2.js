...
class ContestPlayer2 extends Model {
  static async create(val) {
    return ContestPlayer2.fromRecord(ContestPlayer2.model.build(Object.assign({
      contest_id: 0,
      user_id: 0,
      score: 0,
      score_details: '{}',
  ...
  static async findInContest(where) {
    return ContestPlayer2.findOne({ where: where });
  }
  ...
  async updateScore(judge_state) {
    ...
    if (this.contest.type === 'ioi' || this.contest.type === 'pku') {
...
ContestPlayer2.model = model;

module.exports = ContestPlayer2;
