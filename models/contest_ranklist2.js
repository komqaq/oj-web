...
class ContestRanklist2 extends Model {
  static async create(val) {
    return ContestRanklist2.fromRecord(ContestRanklist2.model.build(Object.assign({
      ranking_params: '{}',
      ranklist: '{}'
    }, val)));
  }
  ...
  async getPlayers() {
    ...
    for (let i = 1; i <= this.ranklist.player_num; i++) {
      a.push(await ContestPlayer2.fromID(this.ranklist[i]));
    }
    return a;
  }
...
ContestRanklist2.model = model;

module.exports = ContestRanklist2;
